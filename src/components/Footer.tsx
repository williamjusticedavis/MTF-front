  ...
  return (
    <footer className='bg-gray-800 text-white flex flex-col sm:flex-row justify-between items-center p-6 sm:p-4'>
      <div className='flex flex-col sm:flex-row gap-3 items-center'>
        ...
        <NavLink to="/analytics" className='flex items-center gap-2 hover:underline cursor-pointer'>Analytics<img className='h-[16px] w-5' src="../../Analytics1.png" alt="Analytics" /></NavLink>
