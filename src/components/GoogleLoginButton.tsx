...
const GoogleLoginButton = () => {
    ...
    return (
        <div className="flex justify-center mt-6 w-full">
            <button 
                onClick={() => login()} 
                className="gsi-material-button flex items-center justify-center bg-white text-gray-600 w-full px-4 py-3 rounded-lg shadow-lg hover:shadow-xl hover:bg-gray-100 transition-all duration-300 border border-gray-300"
            >
